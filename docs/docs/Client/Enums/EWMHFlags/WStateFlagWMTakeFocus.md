# WStateFlagWMTakeFocus

Indicates that a client has compatibility with the take focus flag.

This flag can be used to check whether or not a client can be focused.
