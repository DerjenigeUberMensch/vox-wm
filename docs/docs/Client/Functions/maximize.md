...
The [*maximize()*](../maximize) function maximizes the client to fit the screen conforming to strut boundaries of the bar and the boundaries of the screen in the x/y axis.
